...
// MARK: - Shared reciprocity scenario fixtures
// Duplicated from PTimerKitTests (the package test target cannot be
// imported by this app-hosted target). Pure fixtures over PTimerKit
// value types; if a domain type changes, both copies fail to compile.

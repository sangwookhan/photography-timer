...
public struct FilmModeCorrectedExposureDisplayState: Equatable {
    ...
    public init(
        kind: FilmModeCorrectedExposureDisplayKind,
        correctedExposureSeconds: TimeInterval?,
        primaryText: String,
        secondaryText: String,
        usesNumericExposure: Bool
    ) {
        self.kind = kind
...
public struct FilmModeExposureResultState: Equatable {
    ...
    public init(
        ...
        reciprocityState: FilmModeReciprocityStateDisplayState,
        adjustedShutterAction: FilmModeTimerActionState,
        correctedExposure: FilmModeCorrectedExposureDisplayState,
        correctedExposureAction: FilmModeTimerActionState
    ) {

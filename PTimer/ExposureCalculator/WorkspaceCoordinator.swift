...
///
/// PR1+PR2+PR3 (`Docs/StructureImprovement/specs/B1-ViewModelDecomposition.md`):
/// holds `CalculatorModel`, `ReciprocityModel`, `TimerWorkspaceModel`,
/// and the legacy `ExposureCalculatorViewModel`, which still serves as
/// the public observable surface for views until PR5 migrates bindings.
/// PR4 expands to `FilmSelectionModel`. PR6 removes the legacy
/// ViewModel and adds fitness lint rules F5/F8.
///

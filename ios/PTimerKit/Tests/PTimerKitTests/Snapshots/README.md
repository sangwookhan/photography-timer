...
- **Catalog snapshot** — `LaunchPresetFilmCatalogV2.films` (A12 같은 데이터 정정 시 의도된 diff 확인)
...
각 카테고리에 최소 1 baseline. 대표 input은 `ReciprocityPolicyScenarioFactory` 와 `LaunchPresetFilmCatalogV2`에서.

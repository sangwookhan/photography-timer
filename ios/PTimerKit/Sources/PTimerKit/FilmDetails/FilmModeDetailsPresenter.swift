...
public struct FilmModeDetailsPresenterInput {
    ...
    public let filmModeExposureResultState: FilmModeExposureResultState?
    ...
    public let formatAxisDuration: (Double) -> String
    ...
    public let formatSecondsComparison: (Double) -> String?
...
public struct FilmModeDetailsPresenter {
    ...
    public func makeDetailsDisplayState(

...
/// surfaces.
public struct ReciprocityDetailsVocabularyPresenter {
    public init() {}
    ...
    public func tone(for bindingState: FilmModeReciprocityBindingState) -> FilmModeReciprocityStateTone {
    ...
    public func tone(for badgeStyle: ReciprocityConfidenceBadgeStyle) -> FilmModeReciprocityStateTone {
        switch badgeStyle {
        case .trusted:
            return .trusted
        case .measured:
    ...
    /// calculation state.
    public func unofficialProfileAuthorityCaveat(for profile: ReciprocityProfile) -> String? {
    ...
    public func correctedExposureDetailText(
    ...
    public func guidanceExplanation(for presentation: ReciprocityConfidencePresentation) -> String {
    ...
    public func customProfileSection(
        film: FilmIdentity,
    ...
    /// rendering.
    public func customProvenanceText(
        film: FilmIdentity,
        profile: ReciprocityProfile
    ) -> String? {
        var lines: [String] = []

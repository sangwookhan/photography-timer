...
public struct TimerStartComposer {
    ...
    public enum Source {
        ...
        /// order-based marker.
        public var timerExposureSource: ExposureTimerSource? {
            switch self {
        ...
        public var capturesCalculatorIdentity: Bool {
            switch self {
    ...
    public struct Input {
        ...
        public let result: ExposureCalculationResult?
        public let filmModeResult: FilmModeExposureResultState?
    ...
    public func compose(_ input: Input) -> Payload {
    ...
    public static func customProfileSummary(
        film: FilmIdentity?,
    ...
    /// the shape.
    public static func customProfileFormulaText(profile: ReciprocityProfile) -> String? {
        for rule in profile.rules {

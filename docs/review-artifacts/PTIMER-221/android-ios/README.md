...
| | iOS | Android |
| --- | --- | --- |
| build | `main` at `64565f7394fb6d3b00be3655e1b6fb84851c5967` (the merge of the iOS PTIMER-221 PR; also the baseline this Code PR is rebased onto) | `feature/PTIMER-221-android` at `79b339c9` |
...
| captured | 2026-09-23 22:43-23:32 KST | 2026-09-23 23:39 - 2026-09-24 00:23 KST |

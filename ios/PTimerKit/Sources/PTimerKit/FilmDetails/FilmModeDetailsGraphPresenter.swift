...
public struct FilmModeDetailsGraphPresenter {
    ...
    public struct Input {
        ...
        public init(bindingState: FilmModeReciprocityBindingState, calculationResult: Result<ExposureCalculationResult, ExposureCalculatorError>, formatDuration: @escaping (Double) -> String) {

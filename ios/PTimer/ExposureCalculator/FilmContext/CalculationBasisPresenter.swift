...
enum CalculationBasisPresenter {
    ...
    static func calculationBasisText(for formula: ReciprocityFormula) -> String {
    ...
    static func calculationBasisText(for profile: ReciprocityProfile) -> String? {
    ...
    /// Preview card).
    static func calculationBasisText(for form: CustomFilmEditorFormState) -> String? {

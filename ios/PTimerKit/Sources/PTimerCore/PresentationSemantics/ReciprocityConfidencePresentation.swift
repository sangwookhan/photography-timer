...
private extension ReciprocityConfidencePresentation {
    struct Payload {
        ...
        init(level: ReciprocityConfidenceLevel, warningEmphasis: ReciprocityConfidenceWarningEmphasis, shortLabel: String, explanationTokens: [ReciprocityConfidenceExplanationToken], supportingNotes: [String], defaultExplanation: String, returnsCalculatedExposureTime: Bool) {
            self.level = level
            self.warningEmphasis = warningEmphasis
            self.shortLabel = shortLabel
            self.explanationTokens = explanationTokens

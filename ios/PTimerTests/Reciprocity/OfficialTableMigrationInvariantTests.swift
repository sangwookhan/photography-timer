...
final class OfficialTableMigrationInvariantTests: XCTestCase {
    ...
    private let migratedFilms: [MigratedFilm] = [
        ...
        MigratedFilm(stock: "Tri-X 400", anchors: [(1, 2), (10, 50), (100, 1200)], noCorrectionThroughSeconds: 0.999999, sourceRangeThroughSeconds: 100),
        MigratedFilm(stock: "T-MAX 100", anchors: [(10, 15), (100, 200)], noCorrectionThroughSeconds: 0.5, sourceRangeThroughSeconds: 100),
        MigratedFilm(stock: "T-MAX 400", anchors: [(10, 15), (100, 300)], noCorrectionThroughSeconds: 1, sourceRangeThroughSeconds: 100),

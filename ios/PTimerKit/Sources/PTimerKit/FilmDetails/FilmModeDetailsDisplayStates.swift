...
public struct FilmModeDetailsSectionState: Equatable, Identifiable {
    ...
    public init(title: String, rows: [FilmModeDetailsRowState]) {
        self.title = title
        self.rows = rows
    }
}
...
public struct FilmModeDetailsGraphPoint: Equatable {
    ...
    public init(meteredExposureSeconds: Double, correctedExposureSeconds: Double) {
...
public struct FilmModeDetailsGraphSourceReference: Equatable {
    ...
    public init(point: FilmModeDetailsGraphPoint, label: String) {
        self.point = point
        self.label = label
    }
}
...
public struct FilmModeDetailsGraphCurrentPoint: Equatable {
    ...
    public init(point: FilmModeDetailsGraphPoint, style: FilmModeDetailsGraphCurrentPointStyle) {
        self.point = point
        self.style = style
    }
}
...
public struct FilmModeDetailsSummaryState: Equatable {
    ...
    public init(badgeText: String, tone: FilmModeReciprocityStateTone, summaryText: String, detailText: String?) {
...
public struct FilmModeDetailsCurrentResultValueState: Equatable {
    ...
    public init(title: String, valueText: String, detailText: String?, emphasizesValue: Bool) {
        self.title = title
...
public struct FilmModeDetailsModelOption: Equatable, Identifiable {
    ...
    public init(id: String, name: String, selectorLabel: String) {
        self.id = id
        self.name = name
...
public struct FilmModeActiveModelSummary: Equatable {
    ...
    public init(name: String, calculation: String) {
        self.name = name
...
public struct FilmModeDetailsModelSelectionState: Equatable, Identifiable {
    ...
    public init(options: [FilmModeDetailsModelOption], activeOptionID: String) {

...
@MainActor
@Observable
public final class ReciprocityModel {
    ...
    public func formatReciprocitySecondsComparison(
    ...
    public func correctedExposureDisplayState(
        for bindingState: FilmModeReciprocityBindingState?
    ...
    public func correctedExposureActionState(
        for bindingState: FilmModeReciprocityBindingState?

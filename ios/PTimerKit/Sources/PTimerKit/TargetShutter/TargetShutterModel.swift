...
public final class TargetShutterModel {
    ...
    public private(set) var lastUsedTargetSeconds: TimeInterval?

    public var isActive: Bool {
        targetSeconds != nil
    }

    public init(targetSeconds: TimeInterval? = nil) {
    ...
    public func setTarget(_ seconds: TimeInterval?) {

...
final class TableProfileSourceDataContractTests: XCTestCase {
    ...
    private let cases: [TableFilmCase] = [
        ...
        TableFilmCase(
            ...
            detailTokens: ["3s", "20.0s", "50.0s", "180s (3m)"],
        ...
        TableFilmCase(
            ...
            detailTokens: ["3s", "8s", "25s", "75s (1m 15s)", "150s (2m 30s)"],
        ...
        TableFilmCase(
            ...
            detailTokens: ["2s", "10.0s", "30s", "55s", "80s (1m 20s)"],
        ...
        TableFilmCase(
            ...
            detailTokens: ["7.5s", "20.0s", "50.0s", "75s (1m 15s)", "100s (1m 40s)", "150s (2m 30s)"],

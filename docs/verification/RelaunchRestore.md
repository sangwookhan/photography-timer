...
행동 계약: [Timer Spec](../specs/Timer.md) §3 (Persistence and restoration).
...
PR이 timer 영속성·복원에 영향을 주는 경우, 위 5개 시나리오 모두 통과 + automated `TimerManagerTests`의 restore 케이스 통과를 PR 본문에 명시.
